...
#Settings menu
switch_on_switch_off = InlineKeyboardButton('Вкл/Выкл регулярную отправку задач',
...
settings_menu = InlineKeyboardMarkup().add(switch_on_switch_off).add(set_morning_time)
